...
<div class="nnr-sidebar">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<style type="text/css">
				...
				We recommend moving this block and the preceding 
			...
			target="_blank" novalidate style="padding-left: 0;">
				<div id="mc_embed_signup_scroll">
					...
					<input type="text" name="b_82c2341134bbdc37714642adb_642b18616e" 
					tabindex="-1" value=""></div>
					<div><input style="width:100%;" type="submit" 
					value="Subscribe" name="subscribe" class="btn btn-default"></div>
				</div>
			</form>
			</div>
			<script type="text/javascript" src="
			//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js"></script>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="wpsite_feed">
				<script src="http://feeds.feedburner.com/99robots?format=sigpro" 
				type="text/javascript" ></script><noscript><p>
					<?php
					esc_html_e(
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<a class="nnr-sidebar-image-link" href="https://draftpress.com/
			contact?utm_medium=sidebar&utm_campaign=plugin-request-banner" 
			target="_blank">
				<img class="nnr-sidebar-image" 
				src="
				<?php
				echo esc_url(
					$this->plugin_url()
